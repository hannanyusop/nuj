...
<head>
    ...
    <title>Staff Dashboard - Parcel Management System</title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        ...
                        <span class="text-xl font-bold text-gray-900">Staff Dashboard</span>
                    </div>
        ...
        <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            <div class="px-4 py-6 sm:px-0">
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <p class="text-gray-600">Welcome to the staff dashboard. This page will contain staff management functions.</p>

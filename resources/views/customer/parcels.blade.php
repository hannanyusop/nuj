...
<head>
    ...
    <title>My Parcels - Parcel Management System</title>
        ...
        <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            <div class="px-4 py-6 sm:px-0">
                <div class="bg-white rounded-lg shadow p-6">
                    <h1 class="text-2xl font-bold text-gray-900 mb-4">My Parcels</h1>
                    <p class="text-gray-600">This page will show all your parcels with tracking information.</p>

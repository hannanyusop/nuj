...
<head>
    ...
    <title>Customer Login - Parcel Management System</title>
...
<body class="min-h-screen gradient-bg flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-purple-100">Sign in to your customer account</p>
        </div>
        ...
        <div class="glass-effect rounded-2xl p-8 shadow-2xl">
            ...
            <!-- Login Form -->
            <form method="POST" action="{{ route('customer.login') }}" x-data="{ loading: false }">
                @csrf
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('login') }}" class="text-purple-200 hover:text-white text-sm transition-colors">
